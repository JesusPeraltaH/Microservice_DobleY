          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <div className="text-center">
                ...
                <h3 className="mt-2 text-sm font-medium text-black">No hay ventas registradas</h3>
          ...
          <div className="bg-white shadow overflow-hidden rounded-lg">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {sales.map((sale) => (
                  <tr key={sale.id}>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-black">#{sale.id}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-black">{sale.date}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-black">{sale.items} productos</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-black">${sale.total}</td>
                  </tr>
                ))}
              </tbody>
            </table>
